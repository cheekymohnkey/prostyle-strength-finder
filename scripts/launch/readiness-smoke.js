...
function main() {
  ...
  const baseSteps = [
    ...
    { name: "style_dna_taxonomy_seed_apply_coverage_smoke", cmd: "npm run style-dna:taxonomy-seed-apply-coverage-smoke" },
  ...
  const steps = scope === "quick"
    ? baseSteps.filter((step) => [
      ...
      "style_dna_taxonomy_seed_apply_coverage_smoke",
